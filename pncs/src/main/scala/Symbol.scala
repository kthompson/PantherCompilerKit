...
case class Symbol(
  ...
  def tryDefineGiven(
    ...
    tryDefine(name, location, SymbolKind.Given, false)
  ...
  def tryDefineThis(location: TextLocation): Either[TextLocation, Symbol] =
    tryDefine("this", location, SymbolKind.This, true)
