...
//    var last_type_id = 0
//    var type_links = new Array[TypLinks](10)
//
//    def inferTypes(): unit = {
//
//    }
...
//            if (result.isDefined) {
//                getTypeOfSymbol(result.get)
//            } else {
//                panic(location.to_string() + ": getTypeOfString " + name)
//                ErrorType
//            }
//        }
//    }
...
//            getTypeOfSimpleName(name.simpleName.get, scope)
...
//            getTypeOfToken(name.identifierName.get.identifier, scope)
//        } else if (name.kind == SyntaxKind.GenericName) {
//            getTypeOfGenericName(name.genericName.get, scope)
//        } else {
...
//    }
//
//    def getTypeOfGenericName(name: GenericNameSyntax, scope: Scope): Type = {
