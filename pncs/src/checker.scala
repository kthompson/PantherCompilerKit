...
case class Checker(diagnosticBag: DiagnosticBag) {
  ...
  val charType = Type.Named("panther", "char", emptyTypeArray)
  val boolType = Type.Named("panther", "bool", emptyTypeArray)
  val unitType = Type.Named("panther", "unit", emptyTypeArray)

  val noneType =
    Type.Named("panther", "Option", List.Cons(Type.Never, List.Nil))

  // string
//  val stringSymbol = new Symbol(
//    SymbolKind.Class,
//    SymbolFlags.None,
//    "string",
...
//  val message = BoundParameter("message", stringType)
//  setSymbolType(
//    printlnSymbol,
//    Type.Function(
//      List.Cons(message, List.Nil),
//      unitType
//    )
//  )

  // print(message: string): unit
//  val printSymbol = new Symbol(
//    SymbolKind.Method,
//    SymbolFlags.Static,
//    "print",
//    TextLocationFactory.empty(),
...
//  def getTypeOfLiteralExpression(
