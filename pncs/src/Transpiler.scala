...
//  val checker = new Checker(root)
  ...
  def transpileEnumDeclaration(decl: EnumDeclarationSyntax, context: TranspilerContext):unit = {
  ...
  def transpileMatchExpression(expr: MatchExpression, context: TranspilerContext) = {
