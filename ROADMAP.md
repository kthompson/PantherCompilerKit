...
Green: 381 tests across the lexer, parser, binder, type checker, VM, metadata
...
the VM works and `VmTests` drives it in-process for 61 tests.
...
- **Test coverage is stage-shaped, not feature-shaped.** 381 tests, but
