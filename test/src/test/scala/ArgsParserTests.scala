...
class ArgsParserTests extends AnyFunSpec with Matchers {
  ...
  describe("ArgsParser") {
    ...
    it("should parse basic compilation arguments") {
    ...
    it("should handle transpile flag") {
      val result =
    ...
    it("should handle individual debug flags") {
    ...
    it("should handle stack size option") {
      val result =
        ArgsParser.parse(
    ...
    it("should handle heap size option") {
      val result =
        ArgsParser.parse(
    ...
    it("should handle recovery attempts option") {
      val result = ArgsParser.parse(
    ...
    it("should handle diagnostics limit option") {
      val result = ArgsParser.parse(
    ...
    it("should handle transpile with debug options") {
      val result = ArgsParser.parse(
        Array(
          "-t",
          "--trace",
