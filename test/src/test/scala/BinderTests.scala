...
class BinderTests extends AnyFunSpec with Matchers {
  ...
  describe("Binder") {
    it("should create builtin symbols") {
      ...
      assertSymbol(symbols, SymbolKind.Method, "compareTo")
      assertSymbol(symbols, SymbolKind.Parameter, "other")
      assertConversionMethod(symbols)
      assertSymbol(symbols, SymbolKind.Class, "string")
      assertSymbol(symbols, SymbolKind.Field, "length")
      assertSymbol(symbols, SymbolKind.Method, "substring")
      assertSymbol(symbols, SymbolKind.Parameter, "start")
      assertSymbol(symbols, SymbolKind.Parameter, "end")
      assertSymbol(symbols, SymbolKind.Method, "endsWith")
      assertSymbol(symbols, SymbolKind.Parameter, "suffix")
      assertSymbol(symbols, SymbolKind.Method, "compareTo")
      assertSymbol(symbols, SymbolKind.Parameter, "other")
      assertConversionMethod(symbols)
      ...
      assertSymbol(symbols, SymbolKind.Method, "readAllBytes")
      assertSymbol(symbols, SymbolKind.Parameter, "file")
      assertSymbol(symbols, SymbolKind.Method, "writeAllBytes")
      assertSymbol(symbols, SymbolKind.Parameter, "file")
      assertSymbol(symbols, SymbolKind.Parameter, "bytes")
