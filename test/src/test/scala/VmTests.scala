...
class VmTests extends AnyFlatSpec with Matchers {
  ...
  "VM" should "execute constants" in {
  ...
  it should "execute unary operations" in {
    assertExecValueInt("-12", -12)
    assertExecValueInt("+12", 12)
  ...
  it should "execute binary operations" in {
  ...
  it should "execute if expressions" in {
  ...
  it should "execute function calls" in {
  ...
  it should "execute object methods" in {
  ...
  it should "access object fields" in {
  ...
  it should "execute classes without args" in {
    assertExecValueIntWithSetup(
      "class Foo() {\n" +
        " def bar() = 12\n" +
        "}",
...
//    }
  ...
  it should "access class fields via field declaration" in {
    assertExecValueIntWithSetup(
      "class Foo() {\n" +
        "  var x = 12\n" +
        "  var y = 13\n" +
  ...
  it should "execute pattern matching with integer cases" in {
    assertExecValueIntWithSetup(
      "val x = 1",
      "x match {\n  case 1 => 10\n  case 2 => 20\n  case _ => 0\n}",
      10
  ...
  it should "execute pattern matching with wildcard only" in {
    assertExecValueIntWithSetup(
      "val x = 42",
      "x match {\n  case _ => 99\n}",
      99
  ...
  it should "execute is expression basic functionality" in {
  ...
  it should "execute cast expressions - identity casts" in {
  ...
  it should "execute cast expressions - valid conversions" in {
...
//    }
  ...
  it should "execute cast expressions - cast with operators" in {
  ...
  it should "execute cast expressions - cast in control flow" in {
  ...
  it should "execute array indexing - basic access" in {
  ...
  it should "execute array indexing - with assignment" in {
  ...
  it should "execute array indexing - computed indices" in {
  ...
  it should "execute array indexing - in expressions" in {
    val setup =
  ...
  it should "execute array indexing - different types" in {
  ...
  it should "execute string conversions - basic literals" in {
  ...
  it should "execute string conversions - with variables" in {
  ...
  it should "execute string conversions - with expressions" in {
  ...
  it should "execute string conversions - complex expressions" in {
    val setup = "val x = 42\nval y = true"
  ...
  it should "execute string conversions - with control flow" in {
  ...
  it should "execute string conversions - nested and chained" in {
    val setup = "val x = 42"
  ...
  it should "execute string conversions - edge cases" in {
    // Large numbers
  ...
  it should "execute int conversions - basic functionality" in {
  ...
  it should "execute int conversions - string cases" in {
    assertExecValueInt("int(\"42\")", 42)
    assertExecValueInt("int(\"0\")", 0)
    assertExecValueInt("int(\"-123\")", -123)
  ...
  it should "execute bool conversions - basic functionality" in {
  ...
  it should "execute conversion edge cases" in {
  ...
  it should "execute conversions with complex expressions" in {
    val setup = "val x = 42\nval y = true"
