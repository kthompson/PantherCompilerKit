...
class TypeTests extends AnyFunSpec with Matchers {
  ...
  describe("Type checker") {
    ...
    it("should handle int variables") {
      assertExprTypeWithSetup("val x = 12", "x", "int")
    }

    it("should handle bool variables") {
    ...
    it("should handle char variables") {
      assertExprTypeWithSetup("val x = 'a'", "x", "char")
    }

    it("should handle variable addition") {
      assertExprTypeWithSetup("val x = 12", "x + 12", "int")
    }

    it("should handle variable equality") {
    ...
    it("should handle conversions to any") {
    ...
    it("should handle is expressions") {
    ...
    it("should handle block expressions") {
      assertExprTypeTest("{ 1 }", "int")
      assertExprTypeTest("{ true }", "bool")
      assertExprTypeTest("{  }", "unit")
      assertExprTypeTest(
    ...
    it("should handle while expressions") {
    ...
    it("should handle multiple cases with same type") {
      assertExprTypeTest(
        "1 match { case 1 => 10\n case 2 => 20 }",
        "int"
      )
    ...
    it("should handle multiple cases with different types") {
    ...
    it("should handle match with blocks") {
      assertExprTypeTest(
    ...
    it("should handle simple identity generic method") {
    ...
    it("should handle generic method returning concrete type") {
    ...
    it("should handle generic parameter with concrete return") {
    ...
    it("should handle generic container creation") {
    ...
    it("should handle enums without args") {
      val setup = "enum Foo {\n" +
        "  case Bar\n" +
        "  case Baz\n" +
        "}"
    ...
    it("should handle enums with args") {
      val setup = "enum Foo {\n" +
        "  case Bar(x: int)\n" +
        "  case Baz(y: string)\n" +
        "}"
    ...
    it("should handle enums with generic type") {
    ...
    it("should handle list examples") {
    ...
    it("should handle array indexing in expressions") {
    ...
    it("should handle array indexing with computed indices") {
    ...
    it("should handle array indexing assignment - LHS binding fix") {
    ...
    it("should handle primitive casts") {
    ...
    it("should handle variable casts") {
      val setup =
        "val x = 42\nval flag = true\nval ch = 'a'\nval text = \"hello\""
    ...
    it("should handle cast to any type") {
    ...
    it("should handle cast from any type") {
    ...
    it("should handle expression casts") {
    ...
    it("should handle cast with parentheses") {
      assertExprTypeTest("(42) as string", "string")
      assertExprTypeTest("(true) as int", "int")
      assertExprTypeTest("(\"hello\") as any", "any")
    }

    it("should handle chained operations with casts") {
      val setup = "val x = 42"
    ...
    it("should handle basic string conversions") {
    ...
    it("should handle string conversions with variables") {
    ...
    it("should handle string conversions with expressions") {
    ...
    it("should handle string conversions in complex expressions") {
      val setup = "val x = 42\nval y = true"
    ...
    it("should handle string conversions with method calls") {
    ...
    it("should handle string conversions with control flow") {
    ...
    it("should handle nested string conversions") {
      val setup = "val x = 42"
    ...
    it("should handle bool conversions") {
    ...
    it("should handle char conversions") {
